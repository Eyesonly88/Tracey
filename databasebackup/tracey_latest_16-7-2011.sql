...
--
-- Host: localhost
-- Generation Time: Jul 16, 2011 at 09:10 AM
...
CREATE TABLE IF NOT EXISTS `comment` (
  ...
  KEY `c_issue_id` (`IssueId`),
  KEY `c_user_id` (`UserId`)
...
INSERT INTO `comment` (`CommentId`, `IssueId`, `UserId`, `CommentContent`, `CreationDate`, `ModificationDate`) VALUES
(2, 13, 23, 'This is a modified comment yo!', '2011-07-16 19:01:42', '2011-07-16 19:03:49');
...
INSERT INTO `component` (`ComponentId`, `ProjectId`, `CreationDate`, `RequiredHours`) VALUES
(1, 62, NULL, NULL),
(3, 66, NULL, NULL),
(4, 67, NULL, NULL),
(5, 68, NULL, NULL),
...
INSERT INTO `componentwatches` (`ComponentId`, `UserId`) VALUES
(3, 23);
...
INSERT INTO `issue` (`IssueId`, `ComponentId`, `Name`, `Description`, `ReporterId`, `AssigneeId`, `IssueType`, `Priority`, `CreationDate`, `IssueStatus`, `ResolvedDate`, `LastModificationDate`) VALUES
(12, 1, 'AwesomeIssue', 'i''m an awesome', 22, 22, 1, 1, NULL, 3, NULL, '2011-07-13 01:51:22'),
(13, 1, NULL, NULL, 22, 23, 1, 1, '2011-07-12 23:00:46', 4, NULL, '2011-07-12 23:00:46');
...
--
-- Table structure for table `issuewatches`
--

CREATE TABLE IF NOT EXISTS `issuewatches` (
  `UserId` bigint(20) NOT NULL,
  `IssueId` bigint(20) NOT NULL,
...
--
-- Dumping data for table `issuewatches`
--

INSERT INTO `issuewatches` (`UserId`, `IssueId`) VALUES
(23, 14);
...
(66, 'burrewoo', NULL, 23, NULL, NULL),
(67, 'testing it', NULL, 23, NULL, NULL),
(68, 'what do', NULL, 23, NULL, NULL),
(69, 'what do', NULL, 23, NULL, NULL);
...
--
ALTER TABLE `comment`
  ADD CONSTRAINT `c_issue_id` FOREIGN KEY (`IssueId`) REFERENCES `issue` (`IssueId`) ON DELETE CASCADE,
  ADD CONSTRAINT `c_user_id` FOREIGN KEY (`UserId`) REFERENCES `user` (`UserId`) ON DELETE CASCADE;
